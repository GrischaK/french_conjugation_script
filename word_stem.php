...
function word_stem(InfinitiveVerb $infinitiveVerb, Person $person, Tense $tense, Mood $mood) {
	...
	if ($exceptionmodel->getValue () === ExceptionModel::MOURIR && (($mood->getValue () === Mood::Indicatif && $tense->getValue () === Tense::Present && in_array ( $person->getValue (), array (
			Person::FirstPersonSingular,
			Person::SecondPersonSingular,
			Person::ThirdPersonSingular,
			Person::ThirdPersonPlural 
	...
	if ($exceptionmodel->getValue () === ExceptionModel::QUERIR && (($mood->getValue () === Mood::Indicatif && $tense->getValue () === Tense::Present && in_array ( $person->getValue (), array (
			Person::FirstPersonSingular,
			Person::SecondPersonSingular,
			Person::ThirdPersonSingular,
			Person::ThirdPersonPlural 
	...
	if ($exceptionmodel->getValue () === ExceptionModel::BOUILLIR && (($mood->getValue () === Mood::Indicatif && $tense->getValue () === Tense::Present && in_array ( $person->getValue (), array (
			Person::FirstPersonSingular,
			Person::SecondPersonSingular,
			Person::ThirdPersonSingular,
			Person::ThirdPersonPlural 
	...
	if ($exceptionmodel->getValue () === ExceptionModel::DEVOIR && (($mood->getValue () === Mood::Indicatif && $tense->getValue () === Tense::Present && in_array ( $person->getValue (), array (
			Person::FirstPersonSingular,
			Person::SecondPersonSingular,
			Person::ThirdPersonSingular,
			Person::ThirdPersonPlural 
	...
	if ($exceptionmodel->getValue () === ExceptionModel::ENIR && (($mood->getValue () === Mood::Indicatif && $tense->getValue () === Tense::Present && in_array ( $person->getValue (), array (
			Person::FirstPersonSingular,
			Person::SecondPersonSingular,
			Person::ThirdPersonSingular,
			Person::ThirdPersonPlural 
	...
	if ($exceptionmodel->getValue () === ExceptionModel::VALOIR && (($mood->getValue () === Mood::Indicatif && $tense->getValue () === Tense::Present && in_array ( $person->getValue (), array (
			Person::FirstPersonSingular,
			Person::SecondPersonSingular,
			Person::ThirdPersonSingular 
	...
	if ($exceptionmodel->getValue () === ExceptionModel::VALOIR && ($mood->getValue () === Mood::Subjonctif && $tense->getValue () === Tense::Present && in_array ( $person->getValue (), array (
			Person::FirstPersonSingular,
			Person::SecondPersonSingular,
			Person::ThirdPersonSingular,
			Person::ThirdPersonPlural 
