...
<<<<<<< HEAD
	...
	public static $ier = ['abrier','rocouier'];
	public static $yer = ['essuyer', 'noyer', 'payer'];	
	
	public static $e_akut_er = ['accélérer','espérer','sécher','redégénérer'];
	public static $e_akut_cer = ['apiécer'];
	public static $e_akut_ger = ['agréger'];
	public static $e_akut_ier = ['planchéier']; //regular
	public static $e_akut_yer = ['abréyer'];
