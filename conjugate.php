...
require_once '/groups/verbes_pronominaux.php';									// Array mit allen reflexiven Verben
require_once '/groups/verbes_exclusivement_pronominaux.php';	// Array mit allen - ausschließlich - reflexiven Verben
require_once '/groups/verbes_intransitifs.php'; 				// Array mit allen transitiven Verben
require_once '/groups/verbes_transitifs.php';					// Array mit allen intransitiven Verben (manche Verben sowohl transitiv als auch intransitiv sind)
require_once '/groups/irregular-verb-groups.php';

require_once '/groups/verbes_defectifs.php';	// Array mit allen defekten Verben
require_once '/groups/verbes_en_ancien.php';	// Array mit allen Verben aus der altfranzösischen Sprache
